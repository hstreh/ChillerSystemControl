...
plt.savefig('Accuracy_Chiller.png')
plt.show()
...
plt.suptitle('Performance of Neural Network Model on Chiller Data\n', fontsize=16)
plt.tight_layout()

# Removed explicit x-axis limits for synchronized zooming and panning
plt.savefig('NNtrue_vs_predicted_chiller.png')
plt.show()
